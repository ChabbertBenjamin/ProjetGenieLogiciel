			...
			public void actionPerformed(ActionEvent e) {
				...
				Boolean test = true;
				 try {
					...
					pst = con.mkDataBase().prepareStatement("INSERT into employe (nom, prenom, login, motdepasse, role) values (?,?,?,?,?)");
	                ...
	                if(test) {
		               ...
		               JOptionPane.showMessageDialog(null, "Création effectué !");
	                	...
	                	JOptionPane.showMessageDialog(null, "Impossible de créer l'employe (certain champs sont peut-être vide)");
	                }
